...
import Aspirants from "./infoForStudents/Aspirants";
            ...
            <Container className='mt-5 mb-5'
                ...
                <Row>
                    <Col>
                        ...
                        <DocumentsGraduate/>
                        <h5 className="mt-5">Кафедра Информационных компьютерных технологий осуществляет подготовку по
                            программе академической магистратуры:</h5>
                        ...
                        <ContactPriem/>
                        <Button
                            href='http://localhost:3000/introduction/index.html'
